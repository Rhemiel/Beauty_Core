    ...
    <div className="bg-[#1a0a2e] border border-[#b040d8]/15 overflow-hidden transition-all duration-200 hover:border-[#f0a800]/40 hover:-translate-y-0.5">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-1.5 flex-wrap mb-2.5">
          {[d.style, d.finish, d.shape].filter(Boolean).map((t, i) => (
            <span key={`${t}-${i}`} className="font-sans text-[9px] font-semibold tracking-[1px] uppercase text-[#9a7ab8] bg-[#b040d8]/10 px-2 py-[3px]">
              {t}
              </span>
          ))}
        </div>

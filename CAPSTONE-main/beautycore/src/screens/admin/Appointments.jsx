...
import { getAllAppointments, updateAppointmentStatus, createAppointment } from '../../../app/actions'
...
export default function AdminAppointments() {
  ...
  async function addAppt() {
    ...
    formData.append('guestName', form.client)
    formData.append('guestPhone', form.phone)
    formData.append('serviceName', form.service)

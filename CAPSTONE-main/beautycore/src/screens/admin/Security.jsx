...
const ROLES = {
  ...
  stylist: { label:'Stylist',       color:'text-[#b040d8]', bg:'bg-[#b040d8]/15', perms:['View Appointments','Manage Own Clients','Service Catalog','Nail & Hair Studio'] },
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr>
                        ...
                        <th className={thCls + ' text-center'}>Stylist</th>
                        <th className={thCls + ' text-center'}>Client</th>
                      </tr>
                    </thead>
                    <tbody>
                      {PERMISSIONS.map(p => {
                        // Stylist permissions logic
                        const stylistPerm = p.admin && (p.module.includes('Studio') || p.module.includes('Appointments') || p.module.includes('Profile') || p.module.includes('Advisor'));
                        ...
                        return (
                          <tr key={p.module} className="hover:bg-[#b040d8]/5 transition-colors">
                            ...
                            <td className={tdCls + ' text-center'}>
                              {stylistPerm ? <span className="text-[#6fcf97] text-[16px]">✓</span> : <span className="text-[#eb5757] text-[16px]">✗</span>}
                            </td>
                            <td className={tdCls + ' text-center'}>
